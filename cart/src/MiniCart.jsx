                    ...
                    <div className='absolute p-5 border-4 border-blue-800 bg-white' style={{ width: 300, top: "2rem", left:-250 }}>
                        ...
                        <div className='flex'>
                            <div className='flex-grow'>
                                <button id='clearcart' className='bg-white border border-green-800 text-green-800 py-2 px-5 rounded-md' onClick={clearCart}>
                                    Clear Cart
                                </button>
                            </div>
                            <div className='flex-end'>
                                <button id='clearcart' className='bg-green-900 text-white py-2 px-5 rounded-md' onClick={clearCart}>
                                    Checkout
                                </button>
                            </div>
                        </div>
